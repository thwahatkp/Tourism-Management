...
-->
        ...
        <script src="./js/min/lightbox-plus-jquery.min.js"></script>
    ...
    <body>
        ...
        <div class="middle-content">
            ...
            <div class="container-fluid">
                <div class="image-container" id="imagesgets">
                 <?php
                 ...
                 while($row=$result=mysqli_fetch_assoc($query)){?>
                    <a href="./gallery/<?= $row['Src']?>" data-lightbox="mygallery" data-title="<?= $row['Place-name']?>"><img class="gallery_images" src="./gallery/<?= $row['Src']?>"alt=""></a>
                    <?php
                  }
                 }
                  ?>
